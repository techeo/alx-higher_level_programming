...
class Rectangle:
    """To print and compute the dimensions of a rectangle.

    Represents a rectangle with width and height attributes. Provides methods
    for calculating area and perimeter, string representations (__str__,
    __repr__), and a message upon instance deletion (__del__).
