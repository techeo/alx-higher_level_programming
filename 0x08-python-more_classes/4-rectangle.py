...
class Rectangle:
    """Represents a rectangle with width and height attributes. provides method for calculating area and perimeter, and string representations __str__ and __repr__
    ...
    def width(self):
        ...
        Returns:
            int:horizontal dimensions of a rectangle.
