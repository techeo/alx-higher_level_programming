...
class Rectangle:
    """Rectangle class that takes arguments for width and height,
    providing methods for area and perimeter calculations.
    ...
    @property
    def width(self):
        """Getter method for the horizontal dimension.
