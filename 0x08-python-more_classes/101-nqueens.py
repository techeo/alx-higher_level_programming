#!/usr/bin/python3
"""101-nqueens solves the N queens puzzle in all feasible ways.


attempted recursion-free virtual backtracking. In local tests,
the process will clearly slow down for N > 8, and it will work
up to N = 11 before failing for N > 11. Recursion might make a process 
lighter, but this student is still unsure of how to keep track of which 
answers have already been found using that technique.
